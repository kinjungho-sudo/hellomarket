...
-- 입고 소식 & 가드닝 가이드 포스트 (5개)
INSERT INTO hgm_posts (type, title, content, image_url, is_published) VALUES
('new_arrival', '봄 시즌 신상 입고 완료!', '따뜻한 봄을 맞아 새로운 식물들이 입고되었습니다. 히아신스, 수국, 미니 장미 등 봄꽃 식물들이 가득합니다. 매장을 방문하시면 훨씬 다양한 봄 식물들을 만나보실 수 있어요!', '/assets/images/plant-alyssum.jpg', true),
('new_arrival', '거베라 & 봄꽃 한정 입고', '화사한 색상의 거베라가 입고되었습니다! 빨강, 노랑, 흰색 등 다양한 색상으로 만나보실 수 있어요. 수량이 제한되어 있으니 서둘러 주세요.', '/assets/images/plant-gerbera.jpg', true),
('guide', '초보자를 위한 식물 물주기 가이드', '식물을 처음 키우시는 분들이 가장 많이 실패하는 이유가 바로 물주기입니다. 흙이 말랐는지 확인하는 방법, 계절별 물주기 주기, 과습과 건조를 구분하는 법까지 단계별로 알려드립니다. 관엽식물은 주 1회, 다육식물은 2주~1달에 1회가 기본입니다.', '/assets/images/plant-naver1.jpg', true),
('guide', '홈가드닝이란? 집에서 식물 키우기 시작하는 법', '홈가드닝(Home Gardening)은 집 안팎에서 식물을 가꾸는 생활 취미입니다. 화분 하나에서 시작해 베란다 정원, 실내 공기정화 식물까지 — 누구나 쉽게 시작할 수 있습니다. 식물은 스트레스를 낮추고 집 안 공기를 맑게 해주는 자연 인테리어입니다. 초보자에게는 몬스테라, 스투키, 에케베리아처럼 관리가 쉬운 식물부터 추천합니다.', '/assets/images/plant-naver2.jpg', true),
('guide', '광량별 추천 식물 가이드', '식물마다 필요한 빛의 양이 다릅니다. 직사광선이 드는 베란다에는 다육식물·장미·거베라가 잘 자라고, 간접광이 드는 거실에는 몬스테라·스파티필럼·필로덴드론이 적합합니다. 빛이 거의 없는 욕실이나 북향 방에는 스투키·산세베리아·행운목처럼 저광량에 강한 식물을 선택하세요.', NULL, true);
